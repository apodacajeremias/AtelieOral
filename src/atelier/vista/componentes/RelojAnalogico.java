...
public class RelojAnalogico extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 900470095512487903L;
	...
	private class GClock extends GObject {
		...
		public GClock(double x0, double y0, double radius) {
			...
			hourHandleGeometry_ = new double[] { -0.10 * radius_,
					-0.04 * radius_, -0.10 * radius_, +0.04 * radius_,
					+0.60 * radius_, +0.04 * radius_, +0.65 * radius_, 0.0,
					+0.60 * radius_, -0.04 * radius_, -0.10 * radius_,
					-0.04 * radius_ };
			...
			minuteHandleGeometry_ = new double[] { -0.10 * radius_,
					-0.04 * radius_, -0.10 * radius_, +0.04 * radius_,
					+0.90 * radius_, +0.04 * radius_, +0.95 * radius_, 0.0,
					+0.90 * radius_, -0.04 * radius_, -0.10 * radius_,
					-0.04 * radius_ };
			...
			secondHandleGeometry_ = new double[] { -0.10 * radius_,
					-0.02 * radius_, +0.85 * radius_, 0.0, -0.10 * radius_,
					+0.02 * radius_, -0.10 * radius_, -0.02 * radius_ };
		}
